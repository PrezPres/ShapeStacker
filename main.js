...
function create() {
  ...
  // Add countdown timer
  timerText = this.add.text(centerX, centerY + gameHeight + 10, `Time Left: ${countdown}`, {
    font: "18px Arial",
    fill: "#fff",
  });
  ...
  // Shapes in box text
  shapesInBoxText = this.add.text(centerX + gameWidth - 140, centerY + gameHeight + 10), `Shapes in Box: 0`, {
    font: "18px Arial",
    fill: "#fff",
  });
